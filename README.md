...
- ~~adding grobs explicitly with `add_grobs()`; grobs should have layout
  parameters.~~
...
- ~~the nodes of the diagrammer are adjusted to the size of the labels.
  We could do that, actually. I think it doesn’t look so good, but
  OK.~~ - now “tight” layouts
